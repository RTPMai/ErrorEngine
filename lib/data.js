...
// ---- generic key access (used by lib/user-store.js) --------------------------------
// Same kvGet/kvPipeline conventions and the same defensive unwrap — lib/user-store.js
// stores its own maps without duplicating the Upstash fetch layer.
